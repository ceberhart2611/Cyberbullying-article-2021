...
for trecord in test_records:
    ...
    with conn.cursor() as cursor:
        cursor.execute("insert into resSD_8020 values (" + str(trecord.commentid) + ", NULL, '" + str(jud) + "')")
...
for trecord in test_records:
    ...
    with conn.cursor() as cursor:
        cursor.execute("update resSD_8020 set NBjudg = '" + str(jud) + "' where commentid = " + str(trecord.commentid) )
