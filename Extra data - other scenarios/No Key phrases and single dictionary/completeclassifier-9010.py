...
for trecord in test_records:
    ...
    with conn.cursor() as cursor:
        cursor.execute("insert into resNKPSD_9010 values (" + str(trecord.commentid) + ", NULL, '" + str(jud) + "')")
...
for trecord in test_records:
    ...
    with conn.cursor() as cursor:
        cursor.execute("update resNKPSD_9010 set NBjudg = '" + str(jud) + "' where commentid = " + str(trecord.commentid) )
